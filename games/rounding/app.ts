...
function nextQ() {
  ...
  document.getElementById('number')!.textContent = String(currentQ.number);
  document.getElementById('round-to')!.textContent = String(currentQ.roundTo);
